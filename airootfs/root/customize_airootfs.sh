...
cd root/lib32-ncurses5-compat-libs && sudo pacman --noconfirm --needed --needed -U lib32-ncurses5-compat-libs-6.3-1-x86_64.pkg.tar.lzo && cd ../..
rm -rf root/lib32-ncurses5-compat-libs
cd root/payload-dumper-go-bin && sudo pacman --noconfirm -U alg-cala-config-hardened-22.07-4-any.pkg.tar.lzo && cd ../..
rm -rf /root/ala-cala-config-hardened
...
cd root/ala-cala-config-hardened && sudo pacman --noconfirm -U alg-cala-config-xanmod-22.07-4-any.pkg.tar.lzo && cd ../..
rm -rf root/ala-cala-config-xanmod
